...
mod message {
    ...
    use std::str::FromStr;
    use crate::message::{parse_header_frame, parse_question, parse_answer, Record, Message, parse_message};
    use crate::meta::{Header, OpCode, RCode, Question, DNSType, DNSClass, ResourceRecord};
    use crate::edns::EDNS;
    use std::io::Cursor;
    use std::collections::HashMap;
